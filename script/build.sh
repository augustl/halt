...
GCCFLAGS="-Wall -Wextra -Iinclude $GCCFLAGS_DEBUG"
rm -rf target
mkdir -p target
...
$BIN/i686-elf-objcopy --only-keep-debug target/halt_multiboot.bin target/halt_multiboot.sym
$BIN/i686-elf-objcopy --strip-debug target/halt_multiboot.bin
