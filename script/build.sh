...
$BIN/i686-elf-gcc -c boot/multiboot/halt_tty.c -o target/boot/halt_tty.o -Iboot/multiboot/include $GCCFLAGS
$BIN/i686-elf-gcc -T script/linker.ld -o target/halt_multiboot.bin target/boot/halt_multiboot_bootstrap.o target/boot/halt_multiboot_main.o target/boot/halt_tty.o -nostdlib -lgcc
