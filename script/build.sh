...
rm -rf target
mkdir -p target
$BIN/i686-elf-as boot/multiboot/halt_multiboot_bootstrap.s -o target/halt_multiboot_bootstrap.o
$BIN/i686-elf-gcc -c boot/multiboot/halt_multiboot_main.c -o target/halt_multiboot_main.o -Iboot/multiboot/include $GCCFLAGS
$BIN/i686-elf-gcc -T script/linker.ld -o target/halt_multiboot.bin target/halt_multiboot_bootstrap.o target/halt_multiboot_main.o -nostdlib -lgcc
