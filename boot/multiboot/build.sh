...
GCCFLAGS="-Wall -Wextra -g -Iinclude"
rm -rf target
mkdir -p target
...
$BIN/i686-elf-gcc -c halt_multiboot_main.c -o target/halt_multiboot_main.o -std=gnu99 \
    ...
    $GCCFLAGS
$BIN/i686-elf-gcc -T linker.ld -o target/halt_multiboot.bin -ffreestanding -O2 -nostdlib target/halt_multiboot_init.o target/halt_multiboot_main.o -lgcc $GCCFLAGS
